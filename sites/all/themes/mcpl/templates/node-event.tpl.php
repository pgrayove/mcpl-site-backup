 ...
 */
 ...
 $display_submitted = false; //hide the "submitted by" information
?>
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
  ...
  <div class="content">
    <?php print $content; ?>
    <div class="taxonomy_terms">
	<!-- change the value of $vid to the id of a vocabulary to limit the displayed terms to only 1 vocabulary  -->
	<?php
	 if ($terms) { print mcpl_print_terms($node, $vid = NULL, $unordered_list = TRUE);} 
	?>
  </div><!-- /taxonomy_terms -->
    <p><a href="http://events.monroe.lib.in.us/evanced/lib0/emailevent.asp?action=Notify&ID=<?=$node->field_evanced_id[0]['view']?>">Notify me about similar events</a></p>
<p><a href="http://events.monroe.lib.in.us/evanced/lib0/calsync.asp?id=<?=$node->field_evanced_id[0]['view']?>&system=event">Download event to a calendar</a></p>
  </div><!-- /content -->
