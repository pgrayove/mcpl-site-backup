...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
  ...
  <?php
  	...
  	print "<li class='print_page'><a href='/print{$_SERVER['REQUEST_URI']}' title='Print this page' rel='nofollow'><img src='/sites/all/modules/print/icons/print_icon.gif' alt='Email this page' /></a></li>";
