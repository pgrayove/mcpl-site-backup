...
<body class="<?php print $classes; ?>">
     <div id="skip-link">
     	<a href="#megamenu-primary-links"><?php print t('Jump to Navigation'); ?></a>
     	<a href="#main-content"><?php print t('Jump to Main Content'); ?></a>
	<a href="#pdf-links"><?php print t('Jump to PDF version'); ?></a>
     </div>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php if ($title): ?>
          <a name="main-content"></a><h1 class="title <?php if(!empty($node->field_hidetitle[0]['value'])){$hidetitle = $node->field_hidetitle[0]['value']; print $hidetitle;} ?>"><?php print $title; ?></h1>
        <?php endif; ?>
        <?php print $messages; ?>
        <?php if ($tabs): ?>
