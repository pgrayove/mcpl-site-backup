...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
  ...
  <?php endif; ?>
   ...
   <div class="content">
   <?php if($node->field_blog_isbn[0]['view']){ ?>
	    <div id="book_cover_image">
    		<a href="http://mcpl.monroe.lib.in.us/search/searchresults.aspx?type=Boolean&term=isbn=<?=$node->field_blog_isbn[0]['view']?>%20or%20upc=<?=$node->field_blog_isbn[0]['view']?>&by=KW&sort=RELEVANCE?utm_source=blogpost&utm_medium=publicsite&utm_campaign=blogpost"><img class="staffpicks" class="staff-picks" src="http://contentcafe2.btol.com/ContentCafe/Jacket.aspx?Return=1&Type=L&Value=<?=$node->field_blog_isbn[0]['view']?>&userID=monroeco&password=bt0245" alt="<?=$node->field_blog_isbn[0]['view']?>"  /><br>view in catalog</a>
   		 </div>
   	<?php } ?>
    <?php print $content; ?>
  </div>
